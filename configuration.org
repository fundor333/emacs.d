...
#+BEGIN_SRC emacs-lisp
  (setq package-list  '(magit easy-hugo python dracula-theme jedi helm helm-projectile
  	      pdf-tools less-css-mode emojify
          markdown-mode org-bullets auto-complete go-autocomplete
              go-mode web-mode less-css-mode neotree all-the-icons editorconfig
